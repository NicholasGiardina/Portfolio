...
- Developing the documentation and preparing the current Version 2.0 release
...
## Dataset Structure and Research Workflow

This figure summarizes the LLM-assisted workflow I used to create and refine the dataset across its versions. It also shows the organization and purpose of the tables in the current Version 2.0 workbook.

::: {.column-screen-inset}

[![](images/figures/fire-database-workflow.svg){.static-preview .research-figure-preview fig-alt="Two-panel diagram showing the human-supervised and LLM-assisted dataset development workflow and the Version 2.0 workbook structure"}](images/figures/fire-database-workflow.svg){target="_blank"}

:::

::: {.figure-note}

**Dataset:** Fire-use database Version 2.0, developed by Nicholas Giardina. **Figure:** Nicholas Giardina.
